            ...
            function ($templateCache) {
                $templateCache.put('template/treeGrid/treeGrid.html',
                    "<div class=\"table-responsive\">\n" +
                            "<div class=\"newtbl2\">\n" +
                    "   <table class=\"table table75 table-bordered table-striped tree-grid table-grid tbl-rolepermit\">\n" +
                     "   <thead>\n" +
                    "     <tr>\n" +
                    ...
                    "       <td><a ng-click=\"row.branch.expanded = !row.branch.expanded\" class=\"indented\"><div title=\"{{row.branch[expandingProperty.field] || row.branch[expandingProperty]}}\" class=\" tree-label\" " +
                    "              ng-click=\"on_user_click(row.branch)\" compile=\"expandingProperty.cellTemplate\"></div>" +
                    "              <div title=\"{{row.branch[expandingProperty.field] || row.branch[expandingProperty]}}\" ng-if=\"!expandingProperty.cellTemplate\" class=\" tree-label\" ng-click=\"on_user_click(row.branch)\">\n" +
                    "             <div class=\"spanlabel2\"><i ng-class=\"row.tree_icon\"\n" +
                    "              class=\" tree-icon\"></i>{{row.branch[expandingProperty.field] || row.branch[expandingProperty]}}</div></div></a>\n" +
                    "       </td>\n" +
                    "   </tr>\n" +
                    "   </tbody>\n" +
                    " </table>\n" +
                    "</div>\n" +
                    " <table class=\"table table25 table-bordered table-striped table-grid tbl-rolepermit\">\n" +
                     "   <thead>\n" +
                    "     <tr>\n" +
